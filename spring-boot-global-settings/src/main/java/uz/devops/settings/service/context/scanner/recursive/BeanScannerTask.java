package uz.devops.settings.service.context.scanner.recursive;
...
/**
 * @author Nurislom
 * @see uz.devops.settings.service.context.scanner.recursive
...
public class BeanScannerTask extends RecursiveTask<Map<BeanDefinition, BeanAnnotatedField>> {
    ...
    private static Result getValidResult(Object bean, BeanDefinition beanDefinition) {
        ...
        if (isProxyClass(bean)) {
            ...
            beanClass = ConfigurationServiceUtils.classLoader(beanDefinition.getBeanClassName());
        }
